...
<head>
    ...
    <title>Laporan Register Terduga TBC</title>
    <style>
        body {
...
<body onload="window.print()">
    ...
    <div class="title">LAPORAN REGISTER TERDUGA TBC (TBC.06)</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $row->no_sediaan }}</td>
                ...
                <td style="text-align: center; font-weight: bold;">{{ $row->hasil_tcm }}</td>
                <td style="text-align: center;">{{ $row->tindak_lanjut }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
